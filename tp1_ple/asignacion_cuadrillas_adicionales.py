...
def agregar_restricciones(prob, instancia):
    ...
    for (i1,i2), j, d in itertools.product(
        ...
        senses.append('L')
        rhs.append(1)
        names.append(f"Trabajador {i1} y trabajador {i2} no trabajan en una misma orden en un mismo dia si estan conflictuados")
    #Regstrinccion adicional 2
